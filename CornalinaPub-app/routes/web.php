...
Route::get('/empresaEvent/{id}',[EmpresaController::class, 'listEventos'])->name('eventoEmpresa.list');
...
Route::get('/chart', [StatisticController::class, 'index'])->name('estatistic.index');
    ...
    Route::post('/empresas/update/{id}', [EmpresaController::class, 'update'])->name("empresas.update");
